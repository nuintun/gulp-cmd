...
function include(options){
  ...
  return through.obj({ objectMode: true }, function (vinyl, encoding, next){
    ...
    try {
      ...
      includeDepsa.call(this, vinyl, options, included);
      this.push(endVinyl);
    } catch (e) {
      var name = colors.cyan.bold('  gulp-cmd ') + colors.yellow.bold(e.name.toLowerCase());
      var message = colors.red.bold(e.message.toLowerCase());
