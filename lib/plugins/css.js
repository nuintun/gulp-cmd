...
module.exports = function(vinyl, options) {
  ...
  const deps = utils.transportCssDeps(vinyl, options);
  const loaderId = utils.parseAlias('css-loader', options.alias);
  ...
  vinyl.contents = new Buffer(utils.wrapModule(id, deps, code));
