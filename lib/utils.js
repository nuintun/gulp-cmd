...
import { resolve as pResolve, dirname, relative, extname } from 'path';
...
export function resolve(request, referer, options) {
  ...
  if (gutil.isAbsolute(request)) {
    request = pResolve(options.root, request);
